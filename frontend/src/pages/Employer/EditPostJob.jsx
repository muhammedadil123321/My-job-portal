...
export default function EditPostJob() {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      jobType: job.jobType ? String(job.jobType).toLowerCase() : "",
    ...
    <div className="min-h-full bg-gray-50 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-md">Update the job details below</p>
        </div>
  ...
  <input
    ...
    readOnly
    className="w-full px-4 py-2.5 border border-gray-200 rounded-md bg-gray-50 text-gray-900 cursor-not-allowed"
  />
