...
// ❌ REMOVED: import { INITIALEMPLOYER } from "../../jobDetails/jobCardDetails";
import EmployerAvatar from "../../assets/images/workeravathar.png";


export default function EmployerManagement() {
  // ❌ REMOVED: const [employers] = useState(INITIALEMPLOYER);

  // ✅ ADDED: New state management for API data
    ...
    const fetchEmployers = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:5001/api/admin/employers",
          {
            method: "GET",
            headers: {
        ...
        if (data.success) {
          // ✅ Store response in state using setEmployers
  ...
  return (
    <div className="h-full bg-gray-50 p-6">
      ...
      {loading ? (
        ...
        // Table Container - ALL ORIGINAL UI PRESERVED
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {isEmpty ? (
            // Empty State
            <div className="flex items-center justify-center h-64">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {employers.map((employer, index) => (
                    <tr
                      // ✅ CHANGED: Use employer._id instead of employer.id
                      key={employer._id}
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col gap-1">
                          <p className="text-sm text-gray-600">{employer.phoneNumber}</p>
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm text-gray-600">
                          {/* ✅ CHANGED: Format postedDate using toLocaleDateString() */}
                          {new Date(employer.postedDate).toLocaleDateString()}
                        </p>
                      </td>
                    </tr>
                  ))}
